var initFormsLookup = (function () {
	...
	*/
	...
	var categories = [{
	  ...
	  "query": "civil civil -harassment -SH-0 -SUBP-0 -POS-0 -MC- -JURY-0 -INT-2 -INT-3 -FL-1 -EJ-0 -DISC-0 -DAL-0 -AT-1 -APP-1 -APP-0 -ADR-1"
	}, {
	  "id": "civil-harassment",
	...
	var requiredNote = 'Forms marked with the asterisk ("*") are adopted for mandatory use by all courts.'; // export const formsAPIUrl = query => `http://jcc.lndo.site/json/jcc-forms?query=${query}`;
