var initFormsLookup = (function () {
	...
	*/
	...
	var allFormsPageUrl = 'allforms.htm';
	var allFormsCategorizedPageUrl = 'allforms.htm?sort=categories';
	...
	var formsAPIUrl = function formsAPIUrl(query) {
	  return "https://develop-jcc-srl.pantheonsite.io/json/jcc-forms?query=".concat(query);
	};
	...
	var CategoryLinks = function CategoryLinks(actions) {
	  ...
	  return browser(_templateObject2(), FirstColumn(), SecondColumn());
	};
	  ...
	  if (category && category.url) {
	    ...
	    if (!Object.keys(categoryLookup).length == 0) {
	      ...
	      if (categoriesList.length == 1) {
	        return browser(_templateObject3(), categoriesList[0].title.toLowerCase(), categoriesList[0].url, categoriesList[0].title, categoriesList[0].formsUrl ? browser(_templateObject4(), categoriesList[0].formsUrl, categoriesList[0].title) : '');
	      } else {
	        return '';
	      }
	    } else {
	...
	var FormResults = function FormResults(actions, _ref) {
	  ...
	  var FormResult = function FormResult(form) {
	    ...
	    return browser(_templateObject3$1(), formInfoUrl, form.id, formMandatory, form.title, formLanguages, formInfoUrl, form.id, form.title, form.url, form.id, form.title);
	  };
	...
	function _templateObject$4() {
	  var data = _taggedTemplateLiteral(["\n        <div class=\"usa-alert usa-alert--info usa-alert--slim usa-alert--no-icon\" style=\"margin-bottom: 0px\">\n          <div class=\"usa-alert__body\">\n            <p class=\"usa-alert__text\">We're testing a new way to help you find forms. <a target=\"_blank\" rel=\"noreferrer\" href=\"https://www.surveymonkey.com/r/2WZTJ59\" onclick=", ">Share feedback</a>.</p>\n          </div>\n        </div>"]);
	...
	function initFormsLookup(containerEl) {
	  ...
	  containerEl.appendChild(browser(_templateObject2$4(), PilotFeedbackAlert(), allFormsPageUrl, allFormsCategorizedPageUrl)); //
