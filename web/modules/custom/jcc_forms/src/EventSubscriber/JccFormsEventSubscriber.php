...
class JccFormsEventSubscriber implements EventSubscriberInterface {
  ...
  */
  public function setHeaderContentSecurityPolicy(ResponseEvent $event) {
    ...
    $response->headers->set('Content-Security-Policy', "frame-ancestors 'self' courts.ca.gov *.courts.ca.gov *-jcc-courts.pantheonsite.io *-jcc-appellate.pantheonsite.io *-jcc-supremecourt.pantheonsite.io", FALSE);
  }
