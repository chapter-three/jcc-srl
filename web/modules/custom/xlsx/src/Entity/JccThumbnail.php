...
/**
 * Defines the JccThumbnail entity.
 *
 * @ingroup xlsx
 *
 * @ContentEntityType(
 *   id = "jcc_thumbnail",
 *   label = @Translation("JCC Thumbnails"),
 ...
 * )
 */
class JccThumbnail extends ContentEntityBase implements JccThumbnailInterface {
  ...
  public static function baseFieldDefinitions(EntityTypeInterface $entity_type) {
    ...
    $fields['filename'] = BaseFieldDefinition::create('string')
      ->setLabel(t('Thumbnail path (filename)'))
      ->setSettings([
        'max_length' => 255,
        'text_processing' => 0,
      ])
