 ...
 * @ingroup xlsx
 */
interface FormThumbnailInterface extends ContentEntityInterface, EntityChangedInterface, EntityPublishedInterface, EntityOwnerInterface {
  /**
   ...
   *
   * @return \Drupal\xlsx\Entity\FormThumbnailInterface
